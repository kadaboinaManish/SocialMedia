    ...
    <nav class="py-10 px-8 border-b border-gray-200">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center justify-between">
                <div class="menu-left flex items-center flex-row">
                    <img src="./assets/logo1.jpg" alt="Logo" class="w-12 mr-2">
                    <a href="#" class="text-xl">Panda<span
                            class="text-purple-700 font-semibold hover:font-bold">Media</span></a>
                </div>
